...
function M.setup_core()
    ...
    local console_sender = require('console-config.console-sender')
    ...
    wk.add({
        -- [C]onsole
        { "<leader>co", function() vim.cmd("belowright 10split"); vim.cmd("term") end, desc = "[o]pen a console", mode = "n" },
        { "<leader>ce", function() console_sender.send_lines() end, desc = "[e]xecute current line", mode = "n" },
        { "<leader>ce", function() console_sender.send_selected() end, desc = "[e]xecute selection", mode = "v" },
        ...
        { "<leader>tc", coverage.summary, desc = "Test [C]overage" },
        { "<leader>tr", dotnet.testrunner, desc = "Test [R]unner" },
        { "<leader>t", group = "[T]ests" },

        -- [󰘴+T]est runner
        { "<leader><C-t>", group = "[󰘴+T]est runner" },
